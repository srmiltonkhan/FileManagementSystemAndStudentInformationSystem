    ...
    <?php echo $side_nabar_and_content_inner_section; ?>
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Running Student Information</h2>
            </div>
          </header>
            ...
            <div class="container-fluid">
              ...
              <!-- Table Section -->
               <div class="row border">
                <div class="col p-1" >Running Student List</div>
